                ...
                <div class="contact_1i row">
                    ...
                    <div class="col-md-10 col-10">
                        <div class="contact_1ir">
                            ...
                            <p class="mb-0">P.O BOX 203 Ojere, Abeokuta, Ogun State.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="contact_1i row">
                    ...
                    <div class="col-md-10 col-10">
                        <div class="contact_1ir">
                            ...
                            <p class="mb-0">planet001@gmail.com</p>
                            <p class="mb-0">planet002@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row contact_2 mt-4">
            <div class="col-md-3">
                <div class="contact_2r">
                    <h5 class="mb-3">LAGOS OFFICE</h5>
                    <p><i class="fa fa-car col_red me-1"></i> 19A, Emma, Abimbola Cole Street, Lekki Phase 1.</p>
                    <p><i class="fa fa-phone col_red me-1"></i> +234 1234 5689</p>
                    <p><i class="fa fa-globe col_red me-1"></i> <a href="#">planet001@gmail.com</a></p>
                    <p><i class="fa fa-envelope col_red me-1"></i> <a href="#">planet002@gmail.com</a></p>
